...
export const envSchema = z.object({
  ...
  PARAM_API_URL: z.string().min(1, "Environment variable PARAM_API_URL is required"),
  PARAM_API_SECRET: z.string().min(1, "Environment variable PARAM_API_SECRET is required"),
}).strict();
